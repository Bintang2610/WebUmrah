...
<div id="hubmodal" class="fixed text-black inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50 hidden">
    <div class="bg-[#EFF3F4] shadow-lg p-8 w-1/2 rounded-xl relative">
        <!-- Tombol Tutup (Silang) -->
        <button id="closeHub" data-close-hub class="absolute top-7 right-7 text-gray-500 hover:text-gray-700 text-4xl">
            &times;
        </button>
        ...
        <table class="w-full min-w-max rounded-xl text-sm font-semibold bg-white text-left rtl:text-right text-gray-500 dark:text-gray-400">
            <thead class="text-md text-gray-700 dark:text-gray-400">
                <tr class=" border-b">
...
<div id="partmodal" class="fixed text-black inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50 hidden">
    ...
    <div class="grid grid-cols-2 gap-6">
        ...
        <div>
            ...
            <div class="w-full bg-white rounded-lg p-2 text-center relative">
                <div class="border-2 border-dashed border-gray-300 rounded-lg p-2">
                    ...
                    <img src="{{ asset('/images/foto.jpeg') }}" class="w-full h-full object-cover rounded-lg" />
                     </div>
                </div>
            </div>
        </div>
        ...
        <div>
            ...
            <input type="date" readonly class="w-full h-[50px] bg-white text-sm px-2 py-1 border rounded-md mt-1 resize-none" value="1983-03-28"></input>
        </div>
    </div>
...
<div class="relative mx-2 px-10 py-8 mb-8 bg-[#EFF3F4] p-6 rounded-xl">
    ...
    <div class="grid grid-cols-2 gap-6">
        ...
        <div>
            ...
            <input type="date" readonly class="w-full h-[50px] bg-white text-sm px-2 py-1 border rounded-md mt-1 resize-none" value="2024-03-01"></input>
        ...
        <table class="w-full min-w-max rounded-xl text-md font-semibold bg-white text-left rtl:text-right text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                <tr class="bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-600">
                    <th scope="row" class="px-6 py-4 text-center font-medium text-gray-900 whitespace-nowrap dark:text-white">
                        <div class="flex justify-center items-center">
                            <input type="checkbox" class="w-5 h-5 rounded border-gray-300 text-green-500 focus:ring-green-500" checked disabled>
                        </div>
                    </th>
                    <td class="px-6 py-4">
                        <img src="{{ asset('/images/foto.jpeg') }}" alt="Foto" class="w-10 h-10 rounded-full">
                ...
                <tr class="bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-600">
                    <th scope="row" class="px-6 py-4 text-center font-medium text-gray-900 whitespace-nowrap dark:text-white">
                        <div class="flex justify-center items-center">
                            <input type="checkbox" class="w-5 h-5 rounded border-gray-300 text-green-500 focus:ring-green-500" disabled>
                        </div>
                    </th>
                    <td class="px-6 py-4">
                        <img src="{{ asset('/images/foto.jpeg') }}" alt="Foto" class="w-10 h-10 rounded-full">
