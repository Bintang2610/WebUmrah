...
<form action="" method="POST" enctype="multipart/form-data" class="w-full">
    ...
    <div class="mt-8 mb-16 px-8 py-8 bg-white text-black rounded-2xl">
        ...
        <div class="flex items-center mb-8 justify-center">
            <!-- Header Dashboard -->
            <div class="px-2">
                <h2 class="text-xl font-medium text-black"><span class="text-[#0ACC00]">Tambah Data</span> Peserta Jamaah Umrah</h2>
            </div>
        </div>
        ...
        <x-tblhub-dataju></x-tblhub-dataju>
            ...
            <div class="grid grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <textarea readonly name="no_paspor" required placeholder="No. Paspor"
                        class="w-full h-[50px] bg-white text-sm px-2 py-1 border rounded-md mt-1 resize-none">Umrah</textarea>
