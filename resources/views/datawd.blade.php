...
<div class="w-dvh mx-2 my-8 px-6 py-10 bg-white text-white rounded-2xl">
    ...
    <div class="flex space-x-2 flex-shrink-0">
        ...
        <a href="/tambahdatawd" class="bg-white border border-gray-300 px-4 py-2 text-sm text-green-500 rounded-full flex items-center space-x-2 hover:bg-gray-100 transition">
