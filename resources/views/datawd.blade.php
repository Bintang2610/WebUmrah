                    ...
                    <tbody>
                        @foreach ($dataWD as $wisatadomestik)
                            <tr data-open-part class="bg-white hover:bg-gray-50 text-black text-center">
                                <td class="px-6 py-4">
                                    <img src="{{ asset('storage/' . $wisatadomestik->foto_peserta) }}" alt="Foto"
                                ...
                                <td class="px-6 py-4 text-center">
                                    <div class="flex justify-center items-center">
                                        {{$wisatadomestik->date_of_issued_perjalanan}}
                                    </div>
                                </td>
                                <td class="px-6 py-4 text-center">
                                    <div class="flex justify-center items-center">
                                        {{$wisatadomestik->date_of_expiry_perjalanan}}
                                    </div>
                                </td>
                                <td class="px-6 py-4 text-center">
