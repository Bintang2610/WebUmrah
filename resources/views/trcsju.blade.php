...
@section('title', 'Transaksi - Transaksi Jamaah Umrah')
...
<div class="w-dvh mx-2 my-8 px-6 py-10 bg-white text-white rounded-2xl">
    ...
    <div class="flex space-x-2 flex-shrink-0">
        ...
        <a href="/tambahdatatransaksi" class="bg-white border border-gray-300 px-4 py-2 text-sm text-green-500 rounded-full flex items-center space-x-2 hover:bg-gray-100 transition">
  ...
  <div class="flex justify-center items-center gap-4">
    ...
    <!-- Tombol Lihat -->
    <a href="/viewtransactionju" class="text-blue-400 hover:text-blue-500">
        <i class="fa-solid fa-eye"></i>
    </a>

    <!-- Tombol Edit -->
    <a href="/changetransactionju" class="text-yellow-500 hover:text-yellow-600">
