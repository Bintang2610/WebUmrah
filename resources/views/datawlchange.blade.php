...
@section('content')
    <div class="flex items-center justify-center  min-h-screen mb-8 mt-20">
        ...
        <form action="{{ route('wisataluarnegeri.update', $peserta->id) }}" method="POST" enctype="multipart/form-data" class="w-full">
            @csrf
            @method('PUT')
                    ...
                    <div class="grid grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <textarea name="no_paspor" required placeholder="No. Paspor"
                                class="w-full h-[50px] bg-white text-sm px-2 py-1 border rounded-md mt-1 resize-none">{{ $peserta->no_paspor }}</textarea>
                            ...
                            <textarea name="issuing_office" required placeholder="Issuing office"
                                class="w-full h-[50px] bg-white text-sm px-2 py-1 border rounded-md mt-1 resize-none">{{ $peserta->issuing_office }}</textarea>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="date" name="date_of_issued" required value="{{ $peserta->date_of_issued }}"
                                class="w-full h-[50px] bg-white text-sm px-2 py-1 border rounded-md mt-1 resize-none"></input>

                            <!-- Tanggal Lahir -->
                            <label class="block text-sm mb-2 font-medium text-gray-700 mt-5">Date of expiry</label>
                            <input type="date" name="date_of_expiry" required value="{{ $peserta->date_of_expiry }}"
                                class="w-full h-[50px] bg-white text-sm px-2 py-1 border rounded-md mt-1 resize-none"></input>
                        </div>
                    </div>
                </div>
                ...
                <div class="relative mx-2 mt-8 px-10 py-8 mb-8 bg-[#EFF3F4] p-6 rounded-xl">
                    ...
                    <div class="grid grid-cols-2 gap-6">
                        ...
                        <div>
                            <!-- Date of issued -->
                            <label class="block text-sm mb-2 font-medium text-gray-700">Date of issued</label>
                            <input type="date" name="date_of_issued" required value="{{ $peserta->date_of_issued_perjalanan }}"
                                class="w-full h-[50px] bg-white text-sm px-2 py-1 border rounded-md mt-1 resize-none"></input>

                            <!-- Tanggal Lahir -->
                            <label class="block text-sm mb-2 font-medium text-gray-700 mt-5">Date of expiry</label>
                            <input type="date" name="date_of_expiry" required value="{{ $peserta->date_of_expiry_perjalanan }}"
                                class="w-full h-[50px] bg-white text-sm px-2 py-1 border rounded-md mt-1 resize-none"></input>
                    ...
                    <div>
                        ...
                        <div class="relative w-full">
                            ...
                            <textarea id="noteArea" placeholder="Catatan"
                                class="hidden w-full h-[300px] bg-white text-sm px-2 py-1 border rounded-md resize-none pr-10">{{ $peserta->catatan }}</textarea>

                            <!-- Gambar Preview (disembunyikan dulu) -->
                            <div id="imagePreviewContainer"
                                class=" bg-white w-full h-[300px] border items-center py-4 pl-8 rounded-md overflow-hidden flex justify-left">
