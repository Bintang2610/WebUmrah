...
<form action="" method="POST" enctype="multipart/form-data" class="w-full">
    ...
    <div class="mt-8 mb-16 px-8 py-8 bg-white text-black rounded-2xl">
        ...
        <div class="flex items-center mb-8 justify-center">
            <!-- Header Dashboard -->
            <div class="px-2">
                <h2 class="text-xl font-medium text-black"><span class="text-[#F1B900]">Ubah Data</span> Peserta Wisata Domestik</h2>
            </div>
        </div>
...
Etihad</textarea>
  ...
  <textarea id="noteArea" placeholder="Catatan"
    class="w-full h-[300px] bg-white text-sm px-2 py-1 border rounded-md resize-none pr-10">sss
  </textarea>
