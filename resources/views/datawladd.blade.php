...
@section('content')
    <div class="flex items-center justify-center  min-h-screen mb-8 mt-20">
        ...
        <form action="{{ route('wisata.store') }}" method="POST" enctype="multipart/form-data" class="w-full">
            @csrf
            <div class="mt-8 mb-16 px-8 py-8 bg-white text-black rounded-2xl">
                ...
                <x-tblhub-datawl :dataWLN="$dataWLN" />
                    ...
                    <div>
                        ...
                        <div class="relative w-full">
                            ...
                            <div class="absolute bottom-2 left-2 text-gray-500 cursor-pointer">
                                ...
                                <!-- Input File Hidden -->
                                <input type="file" name="foto_catatan" required id="imageUpload" accept="image/*" class="hidden">
                            </div>
                        </div>
