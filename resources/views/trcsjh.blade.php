...
@section('title', 'Transaksi - Transaksi Jamaah Haji')
...
<div class="w-dvh mx-2 my-8 px-6 py-10 bg-white text-white rounded-2xl">
  ...
  <div class="flex justify-center items-center gap-4">
    ...
    <!-- Tombol Lihat -->
    <a href="/viewtransactionjh" class="text-blue-400 hover:text-blue-500">
        <i class="fa-solid fa-eye"></i>
    </a>

    <!-- Tombol Edit -->
    <a href="/changetransactionjh" class="text-yellow-500 hover:text-yellow-600">
