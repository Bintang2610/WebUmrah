...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <section class="bg-[url('https://thumb.viva.co.id/media/frontend/thumbs3/2022/03/11/622aef6626cd2-mekah-kabah_1265_711.jpg')] bg-cover bg-center min-h-screen w-full">
        <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
            <div class="w-full bg-white rounded-lg shadow-[0_0_15px_15px_rgba(255,255,255,0.6)] dark:bg-gray-800 md:mt-0 sm:max-w-md xl:p-0">
