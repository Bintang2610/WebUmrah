...
document.addEventListener("DOMContentLoaded", function () {
    const komentar = document.querySelector(".komentar3");

    let posX = window.innerWidth / 2 - 350; // Mulai dari tengah
    let speed = 0.3; // Kecepatan tetap
    let direction = -1; // Mulai dengan arah ke kiri
...
document.addEventListener("DOMContentLoaded", function () {
    const komentar = document.querySelector(".komentar4");
